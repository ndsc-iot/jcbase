    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-time"></i> 全网摄像头联动拍图</h2>
            ...
            <div class="box-content">
            	<!-- <div class="alert alert-info"> -->
                    	...
                    	<button id="op_class_add" type="button" onclick="command(this)" class="btn btn-info btn-lg" value="0" ><i
                                class="glyphicon glyphicon-time glyphicon-white"></i>全网拍图</button>
      					<div class="row">
      						<span> &nbsp;&nbsp;</span>
      					</div> 
   ...
   $(window).load(function(){
	...
	function command(which){
		...
		$.ajax({
			    ...
			    dataType: 'json',
			    async: false,
			    url: "<%=request.getContextPath()%>"+"/imageall/submitCmd",
			    data: {},
			    timeout:10000,
